...
public class Human {
	public int ID;                       //人的ID
	public boolean disabled;             //是否已经到达终点
	public Direction_4D desired_dir;     //期望速度的方向
	public Location location;            //当前坐标
	public Direction Fdirection;         //受力方向
	public double Force;                 //受力大小
	public Direction Vdirection;         //真实速度方向
	public double Velocity;              //真实速度大小
	public double desired_velocity = 1;  //期望速度
	public static double radius = 0.2;   //人的半径
	public static double M = 60.0;       //人的质量
	public ArrayList<Location> path;     //人走过的路径（输出时用）
	...
	public boolean IsTouched_h2h(Human A, Human B) {
		if (Location.getDistance(A.location, B.location) <= Human.radius) return true;
		else return false;
	}
